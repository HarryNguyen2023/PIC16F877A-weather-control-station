 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  flag = 0;
# 628 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c90\\common\\doprnt.c"
  if(*f == '.') {
   flag |= 0x4000;
   f++;
...
# 688 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c90\\common\\doprnt.c"
  case 'f':
   flag |= 0x400;
   break;
# 776 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c90\\common\\doprnt.c"
dostring:


   if(prec && (prec < ((int)len)))
    len = (unsigned int)prec;
# 793 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c90\\common\\doprnt.c"
   while(len--)
    ((*sp++ = (*cp++)));
...
# 1201 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c90\\common\\doprnt.c"
    {
# 1214 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c90\\common\\doprnt.c"
    if(flag & 0x03)
...
# 1316 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c90\\common\\doprnt.c"
  if(prec == 0 && val == 0)
   prec++;
...
# 1559 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c90\\common\\doprnt.c"
 }
