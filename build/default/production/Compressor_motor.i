...
void SpeedControl(float Kp, float targetVal, float nowVal)
{
    ...
    if(PWMval > 16000000/(16*2000))
        PWMval = 16000000/(16*2000);
    else if(PWMval < 70)
        PWMval = 0;
